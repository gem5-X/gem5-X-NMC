...
output_dir="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/${kernel_name}_halfCache"

mkdir "$output_dir"
ln -s /home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/firstLaunchNewPimcores/cpt.7494845714500 /home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/"${kernel_name}_halfCache"/
...
--remote-gdb-port=0 \
-d /home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/"${kernel_name}_halfCache" \
