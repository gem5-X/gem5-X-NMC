...
singularity exec instance://"$kernel_name" ./build/ARM/buildDRAMs/GDDR5_NEW.fast \
--remote-gdb-port=0 \
...
--ramulator-config=/home/kodra/shares/local/scrap/gem5-x-cnm/ext/ramulator/Ramulator/configs/GDDR5_AB-config.cfg \
--pim_mem_size=16GB \
-r 1
