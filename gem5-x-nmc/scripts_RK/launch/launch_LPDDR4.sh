 #!/bin/bash
# Arrrin te ndryshohet pim mode, po nuk vazhdon me tutje
kernel_name=$1
...
singularity exec instance://"$kernel_name" ./build/ARM/buildDRAMs/LPDDR4.fast \
--remote-gdb-port=0 \
...
--ramulator-config=/home/kodra/shares/local/scrap/gem5-x-cnm/ext/ramulator/Ramulator/configs/LPDDR4_AB-config.cfg \
--pim_mem_size=16GB \
-r 1
