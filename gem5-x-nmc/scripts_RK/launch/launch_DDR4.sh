...
output_dir="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/debug_SSDResNet34_DDR4/$kernel_name"
...
singularity exec instance://"$kernel_name" ./build/ARM/buildDRAMs/DDR4_NEW.fast \
--remote-gdb-port=0 \
-d /home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/debug_SSDResNet34_DDR4/"$kernel_name" \
...
--ramulator-config=/home/kodra/shares/local/scrap/gem5-x-cnm/ext/ramulator/Ramulator/configs/DDR4_AB-config.cfg \
--pim_mem_size=16GB \
-r 1
