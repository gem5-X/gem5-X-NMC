...
LOG_FOLDER=/home/kodra/shares/local/scrap/gem5-x-cnm/logs
...
APPLICATIONS_DIR=/home/kodra/shares/local/scrap/gem5-x-cnm/applications/SSDResNet_LPDDR4
...
for i in "$APPLICATIONS_DIR"/* ; do
    (
        ...
        exec="./SSDResNet_LPDDR4/$application" 
        echo "----------------------------------------------------"
