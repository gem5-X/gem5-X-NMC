...
LOG_FOLDER=/home/kodra/shares/local/scrap/gem5-x-cnm/logs_ResDenseGDDR5
...
APPLICATIONS_DIR=/home/kodra/shares/local/scrap/gem5-x-cnm/applications/SSDRes_Dense_GDDR5
...
for i in "$APPLICATIONS_DIR"/* ; do
    (
        ...
        exec="./SSDRes_Dense_GDDR5/$application" 
        echo "----------------------------------------------------"
        ...
        /usr/bin/python3 -u $GEM5X_PATH/scripts_RK/runFSpython/run_fs_sim_command_GDDR5.py $application $exec  2>&1 | tee $LOG_FILE
    ) &
