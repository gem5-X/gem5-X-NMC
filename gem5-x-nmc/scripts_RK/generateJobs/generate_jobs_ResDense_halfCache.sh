...
LOG_FOLDER=/home/kodra/shares/local/scrap/gem5-x-cnm/logs_halfCache
...
for i in "$APPLICATIONS_DIR"/* ; do
    (
        ...
        /usr/bin/python3 -u $GEM5X_PATH/scripts_RK/runFSpython/run_fs_sim_command_halfCache.py $application $exec  2>&1 | tee $LOG_FILE
    ) &
