...
LOG_FOLDER=/home/kodra/shares/local/scrap/gem5-x-cnm/logs_convTestCases
...
APPLICATIONS_DIR=/home/kodra/shares/local/scrap/gem5-x-cnm/applications/CnMConvTestCases
...
for i in "$APPLICATIONS_DIR"/* ; do
    (
        ...
        exec="./CnMConvTestCases/$application" 
        echo "----------------------------------------------------"
        ...
        /usr/bin/python3 -u $GEM5X_PATH/scripts_RK/runFSpython/run_fs_sim_command.py $application $exec  2>&1 | tee $LOG_FILE
    ) &
