...
LOG_FOLDER=/home/kodra/shares/local/scrap/gem5-x-cnm/logs_ResDenseLPDDR4
...
APPLICATIONS_DIR=/home/kodra/shares/local/scrap/gem5-x-cnm/applications/SSDRes_Dense_LPDDR4
...
for i in "$APPLICATIONS_DIR"/* ; do
    (
        ...
        exec="./SSDRes_Dense_LPDDR4/$application" 
        echo "----------------------------------------------------"
        ...
        /usr/bin/python3 -u $GEM5X_PATH/scripts_RK/runFSpython/run_fs_sim_command_LPDDR4.py $application $exec  2>&1 | tee $LOG_FILE
    ) &
