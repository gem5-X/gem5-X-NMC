...
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/SSDRESNET default/UniqueLayers"
# res4b branch2a no stats - same as 4c 2a, replaces in the Unique folder
# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_default_aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_default.csv"      # Final CSV file

# Initialize aux file (empty it if it already exists)
> "$AUX_FILE"

# Loop over the dirs in SSDRESNET default
