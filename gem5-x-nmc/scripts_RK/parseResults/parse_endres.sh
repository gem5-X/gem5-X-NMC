#!/bin/bash
# usage ./parse_endrs.sh experiment (experiment = DDR4, default, GDDR5, doubleCache, halfCache)
GEM5_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/"
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/SSDRESNET EndResDense $1"
# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_EndResDense_$1_aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_EndResDense_$1.csv"      # Final CSV file

# Initialize aux file (empty it if it already exists)
> "$AUX_FILE"

# Loop over the dirs in SSDRESNET EndResDense_DDR4
