...
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/PaperExperiments"

# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/PaperExperiments/RESULTS/aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/PaperExperiments/RESULTS/results.csv"      # Final CSV file
