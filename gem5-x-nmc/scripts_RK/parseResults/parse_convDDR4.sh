...
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/SSDRESNET $1"

# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_$1_aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_$1.csv"      # Final CSV file
