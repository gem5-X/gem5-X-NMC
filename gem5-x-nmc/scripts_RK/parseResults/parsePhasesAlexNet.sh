...
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/PaperExperiments/PhasesAlexNet"

# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/PaperExperiments/RESULTS/aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/PaperExperiments/RESULTS/AlexNetPhases_results.csv"      # Final CSV file
...
for d in "$RESULTS_DIR"/*/ ; do
    ...
    stats_file=$(find "$d" -maxdepth 1 -type f -name "*stats.txt" | head -n 1)
