...
RESULTS_DIR="/home/kodra/shares/local/scrap/gem5-x-cnm/gem5_outputs/SSDRESNET doubleCache"
# Define output files
AUX_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_doubleCache_aux.txt"  # Aux file
CSV_FILE="$GEM5_DIR/gem5_outputs/RESULTS/SSDRESNET_doubleCache.csv"      # Final CSV file

# Initialize aux file (empty it if it already exists)
> "$AUX_FILE"

# Loop over the dirs in SSDRESNET doubleCache
